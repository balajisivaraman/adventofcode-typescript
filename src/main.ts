...
switch (day) {
  ...
  case 'day02':
    ...
    break;
  case 'day04':
    console.log("Day 06, Part 1: ", day04a(parseInputAsStrings(fileName)));
    console.log("Day 06, Part 2: ", day04b(parseInputAsStrings(fileName)));
    break;
  case 'day05':
  ...
  case 'day06':
    ...
    console.log("Day 06, Part 1: ", day06(input, 4));
    console.log("Day 06, Part 2: ", day06(input, 14));
    break;
}
